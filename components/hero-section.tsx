...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen overflow-hidden rounded-b-[20px] bg-black">
      ...
      {/* Spline 3D Model Overlay (lazy + GPU-friendly) */}
      <motion.div
      ...
      >
        <div className="container-custom text-center text-white">
          <Reveal delay={0.2}>
            <motion.p
              className="text-lg md:text-xl text-white/90 mb-12 leading-relaxed italic"
      ...
      >
        <button
          className="bg-white text-black px-6 py-3 rounded-full font-semibold text-sm hover:bg-white/90 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          onClick={() => {
            const el = document.getElementById('lets-work-together')
      ...
      >
        <div className="mx-6 mb-6 px-8 py-6 text-center text-white/90">
          <p className="text-sm leading-relaxed italic" style={{ fontFamily: "'Ivy Presto', serif" }}>
